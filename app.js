...
var getToDosByListName = (req, res) =>
  __async(void 0, null, function* () {
    try {
  ...
  __async(void 0, null, function* () {
    try {
      const updateToDoSchema = import_zod2.z.object({
        toDoId: import_zod2.z.number().int(),
...
app.get("/todos/:listId", getToDosByListName);
